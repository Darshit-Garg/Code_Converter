...
def serializedATN():
    return [
        4,1,4,18,2,0,7,0,2,1,7,1,2,2,7,2,1,0,4,0,8,8,0,11,0,12,0,9,1,1,1,
        1,1,2,1,2,1,2,1,2,1,2,0,0,3,0,2,4,0,0,15,0,7,1,0,0,0,2,11,1,0,0,
        0,4,13,1,0,0,0,6,8,3,2,1,0,7,6,1,0,0,0,8,9,1,0,0,0,9,7,1,0,0,0,9,
        10,1,0,0,0,10,1,1,0,0,0,11,12,3,4,2,0,12,3,1,0,0,0,13,14,5,2,0,0,
        14,15,5,1,0,0,15,16,5,3,0,0,16,5,1,0,0,0,1,9
    ]
...
class PythonSubsetParser ( Parser ):
    ...
    ruleNames =  [ "program", "statement", "assignment" ]
    ...
    class AssignmentContext(ParserRuleContext):
        ...
        def ID(self):
            return self.getToken(PythonSubsetParser.ID, 0)

        def NUMBER(self):
            return self.getToken(PythonSubsetParser.NUMBER, 0)
    ...
    def assignment(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 13
            self.match(PythonSubsetParser.ID)
            self.state = 14
            self.match(PythonSubsetParser.T__0)
            self.state = 15
            self.match(PythonSubsetParser.NUMBER)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
